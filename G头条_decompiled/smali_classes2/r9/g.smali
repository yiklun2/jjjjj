...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lr9/g;->d:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lr9/g;->c:Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lr9/g;->c:Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;

    invoke-direct {p0, v0}, Lr9/g;-><init>(Ljava/util/concurrent/ThreadFactory;)V
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lr9/g;->b:Ljava/util/concurrent/atomic/AtomicReference;

    .line 4
    invoke-static {p1}, Lr9/g;->f(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static f(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 1
    invoke-static {p0}, Lr9/f;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public b()Lf9/m$c;
    ...
    iget-object v1, p0, Lr9/g;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lr9/g$a;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lg9/c;
    ...
    .line 2
    :try_start_0
    iget-object p1, p0, Lr9/g;->b:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public e(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lg9/c;
    ...
    .line 2
    iget-object p4, p0, Lr9/g;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p5, p1, p4}, Lr9/b;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 6
    :goto_0
    invoke-virtual {p5, p1}, Lr9/b;->b(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
