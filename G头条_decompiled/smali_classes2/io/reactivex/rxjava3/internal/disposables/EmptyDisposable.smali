...
.field public static final synthetic b:[Lio/reactivex/rxjava3/internal/disposables/EmptyDisposable;
...
.method public static constructor <clinit>()V
    ...
    .line 3
    sput-object v3, Lio/reactivex/rxjava3/internal/disposables/EmptyDisposable;->b:[Lio/reactivex/rxjava3/internal/disposables/EmptyDisposable;
...
.method public static complete(Lf9/b;)V
    .locals 1
    ...
    invoke-interface {p0, v0}, Lf9/b;->onSubscribe(Lg9/c;)V

    .line 6
    invoke-interface {p0}, Lf9/b;->onComplete()V

    return-void
.end method

.method public static complete(Lf9/g;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lf9/g;->onSubscribe(Lg9/c;)V

    .line 4
    invoke-interface {p0}, Lf9/g;->onComplete()V

    return-void
.end method

.method public static complete(Lf9/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lf9/l;->onSubscribe(Lg9/c;)V

    .line 2
    invoke-interface {p0}, Lf9/l;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lf9/b;)V
    .locals 1

    .line 3
    sget-object v0, Lio/reactivex/rxjava3/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/rxjava3/internal/disposables/EmptyDisposable;

    invoke-interface {p1, v0}, Lf9/b;->onSubscribe(Lg9/c;)V

    .line 4
    invoke-interface {p1, p0}, Lf9/b;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lf9/g;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lf9/g;->onSubscribe(Lg9/c;)V

    .line 8
    invoke-interface {p1, p0}, Lf9/g;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lf9/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Lf9/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lf9/o;->onSubscribe(Lg9/c;)V

    .line 6
    invoke-interface {p1, p0}, Lf9/o;->onError(Ljava/lang/Throwable;)V
