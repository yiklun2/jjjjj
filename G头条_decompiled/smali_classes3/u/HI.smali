...
# static fields
.field public static final Companion:Lu/HI$Companion;
...
.field private mPayOrderBean:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
.end field
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lu/HI$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lu/HI$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lu/HI;->Companion:Lu/HI$Companion;
...
.method public static final synthetic access$getMClRecommendChannel$p(Lu/HI;)Landroidx/constraintlayout/widget/ConstraintLayout;
    .locals 0

    .line 1
    iget-object p0, p0, Lu/HI;->mClRecommendChannel:Landroidx/constraintlayout/widget/ConstraintLayout;

    return-object p0
.end method

.method public static final synthetic access$getMDataBeanX$p(Lu/HI;)Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;
    .locals 0

    .line 1
    iget-object p0, p0, Lu/HI;->mDataBeanX:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;

    return-object p0
.end method

.method public static final synthetic access$getMPayOrderAdapter$p(Lu/HI;)Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderAdapter;
    .locals 0

    .line 1
    iget-object p0, p0, Lu/HI;->mPayOrderAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderAdapter;

    return-object p0
.end method

.method public static final synthetic access$getMPayOrderBean$p(Lu/HI;)Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;
    .locals 0

    .line 1
    iget-object p0, p0, Lu/HI;->mPayOrderBean:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;

    return-object p0
.end method

.method public static final synthetic access$getMPayOrderNoRecAdapter$p(Lu/HI;)Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderNoRecAdapter;
    .locals 0

    .line 1
    iget-object p0, p0, Lu/HI;->mPayOrderNoRecAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderNoRecAdapter;

    return-object p0
.end method

.method public static final synthetic access$getMType$p(Lu/HI;)I
    .locals 0

    .line 1
    iget p0, p0, Lu/HI;->mType:I

    return p0
.end method

.method public static final synthetic access$get_mActivity$p$s2305(Lu/HI;)Lcn/oogqw/cgi/bcilz/fragmentation/SupportActivity;
    .locals 0
...
.method public static final synthetic access$setMClRecommendChannel$p(Lu/HI;Landroidx/constraintlayout/widget/ConstraintLayout;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lu/HI;->mClRecommendChannel:Landroidx/constraintlayout/widget/ConstraintLayout;

    return-void
.end method

.method public static final synthetic access$setMDataBeanX$p(Lu/HI;Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lu/HI;->mDataBeanX:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;

    return-void
.end method

.method public static synthetic b(Lu/HI;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lu/HI;->initNormalChannelAdapter$lambda-3(Lu/HI;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V

    return-void
.end method

.method public static synthetic c(Lu/HI;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lu/HI;->initNormalNoRecChannelAdapter$lambda-2(Lu/HI;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V

    return-void
.end method

.method private final initNormalChannelAdapter(Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;)V
    .locals 5
    ...
    invoke-virtual {p1}, Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;->getChannelData()Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean;
    ...
    iput-object v0, p0, Lu/HI;->mPayOrderAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderAdapter;

    .line 4
    new-instance p1, Lu/e;

    invoke-direct {p1, p0}, Lu/e;-><init>(Lu/HI;)V
    ...
    :cond_5
    iget-object p1, p0, Lu/HI;->mPayOrderAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderAdapter;
    ...
    :cond_7
    new-instance v0, Lu/HI$initNormalChannelAdapter$2;

    invoke-direct {v0, p0}, Lu/HI$initNormalChannelAdapter$2;-><init>(Lu/HI;)V
...
.method private static final initNormalChannelAdapter$lambda-3(Lu/HI;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V
    .locals 4
    ...
    .line 2
    iget-object v3, p0, Lu/HI;->mPayOrderAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderAdapter;
    ...
    :goto_9
    iput-object p2, p0, Lu/HI;->mDataBeanX:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;

    .line 5
    iget-object p1, p0, Lu/HI;->mClRecommendChannel:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method private final initNormalNoRecChannelAdapter(Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;)V
    .locals 6
    ...
    iput-object v0, p0, Lu/HI;->mDataBeanX:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;
    ...
    iput-object v0, p0, Lu/HI;->mPayOrderNoRecAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderNoRecAdapter;

    .line 7
    new-instance p1, Lu/f;

    invoke-direct {p1, p0}, Lu/f;-><init>(Lu/HI;)V
    ...
    :cond_6
    iget-object p1, p0, Lu/HI;->mPayOrderNoRecAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderNoRecAdapter;
    ...
    :cond_8
    new-instance v0, Lu/HI$initNormalNoRecChannelAdapter$2;

    invoke-direct {v0, p0}, Lu/HI$initNormalNoRecChannelAdapter$2;-><init>(Lu/HI;)V
...
.method private static final initNormalNoRecChannelAdapter$lambda-2(Lu/HI;Lcom/chad/library/adapter/base/BaseQuickAdapter;Landroid/view/View;I)V
    .locals 4
    ...
    .line 2
    iget-object v3, p0, Lu/HI;->mPayOrderNoRecAdapter:Ltop/wjtinf/nggka/iapkg/adapter/release/PayOrderNoRecAdapter;
...
.method private final initRec()V
    ...
    iget-object v0, v0, Lub/e;->c:Lcn/oogqw/cgi/bcilz/livedata/StateLiveData;

    new-instance v1, Lu/HI$initRec$1;

    invoke-direct {v1, p0}, Lu/HI$initRec$1;-><init>(Lu/HI;)V
    ...
    iget-object v0, v0, Lub/e;->d:Lcn/oogqw/cgi/bcilz/livedata/StateLiveData;

    new-instance v1, Lu/HI$initRec$2;

    invoke-direct {v1, p0}, Lu/HI$initRec$2;-><init>(Lu/HI;)V
...
.method public initView()V
    ...
    :goto_0
    const-string v1, "null cannot be cast to non-null type top.wjtinf.nggka.iapkg.bean.vip.PayOrderBean"

    invoke-static {v0, v1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    check-cast v0, Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;

    iput-object v0, p0, Lu/HI;->mPayOrderBean:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;
    ...
    .line 6
    :goto_3
    iget-object v0, p0, Lu/HI;->mPayOrderBean:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;
    ...
    .line 7
    :cond_6
    invoke-virtual {v0}, Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;->getAdviceWell()Ljava/lang/String;
    ...
    .line 11
    :goto_4
    invoke-virtual {v0}, Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;->getPayWell()Ljava/lang/String;
    ...
    .line 15
    :goto_5
    invoke-virtual {v0}, Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;->getChannelData()Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean;
    ...
    invoke-virtual {v0}, Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;->getData()Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$DataBean;
    ...
    iput-object v6, p0, Lu/HI;->mDataBeanX:Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean$ChannelDataBean$DataBeanX;
    ...
    iput-object v6, p0, Lu/HI;->mClRecommendChannel:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    new-instance v10, Lu/HI$initView$2$1;

    invoke-direct {v10, p0, v8, v9}, Lu/HI$initView$2$1;-><init>(Lu/HI;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/internal/Ref$ObjectRef;)V
    ...
    .line 40
    invoke-direct {p0, v0}, Lu/HI;->initNormalChannelAdapter(Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;)V
    ...
    .line 48
    invoke-direct {p0, v0}, Lu/HI;->initNormalNoRecChannelAdapter(Ltop/wjtinf/nggka/iapkg/bean/vip/PayOrderBean;)V
    ...
    new-instance v1, Lu/HI$initView$3;

    invoke-direct {v1, p0}, Lu/HI$initView$3;-><init>(Lu/HI;)V
    ...
    new-instance v1, Lu/HI$initView$4;

    invoke-direct {v1, p0}, Lu/HI$initView$4;-><init>(Lu/HI;)V

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 55
    invoke-direct {p0}, Lu/HI;->initRec()V
