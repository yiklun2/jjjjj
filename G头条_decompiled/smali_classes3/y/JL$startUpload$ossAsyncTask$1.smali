.class public final Ly/JL$startUpload$ossAsyncTask$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ly/JL;->startUpload(Lcom/luck/picture/lib/entity/LocalMedia;Ljava/io/File;)V
.end annotation
...
# direct methods
.method public constructor <init>(Ly/JL;Ljava/io/File;Lcom/luck/picture/lib/entity/LocalMedia;)V
    .locals 0

    iput-object p1, p0, Ly/JL$startUpload$ossAsyncTask$1;->this$0:Ly/JL;

    iput-object p2, p0, Ly/JL$startUpload$ossAsyncTask$1;->$zipFile:Ljava/io/File;

    iput-object p3, p0, Ly/JL$startUpload$ossAsyncTask$1;->$localMedia:Lcom/luck/picture/lib/entity/LocalMedia;
...
.method public static synthetic a(Ly/JL;)V
    .locals 0

    invoke-static {p0}, Ly/JL$startUpload$ossAsyncTask$1;->success$lambda-0(Ly/JL;)V

    return-void
.end method

.method private static final success$lambda-0(Ly/JL;)V
    .locals 2
    ...
    .line 2
    invoke-static {p0}, Ly/JL;->access$getMUploadInfoBean$p(Ly/JL;)Ltop/wjtinf/nggka/iapkg/bean/release/UploadInfoBean;
    ...
    .line 5
    invoke-static {p0}, Ly/JL;->access$getFileNames$p(Ly/JL;)Ljava/util/ArrayList;
...
.method public final getProgress()I
    ...
    .line 1
    iget v0, p0, Ly/JL$startUpload$ossAsyncTask$1;->progress:I
...
.method public onFailure(Lcom/alibaba/sdk/android/oss/model/PutObjectRequest;Lcom/alibaba/sdk/android/oss/ClientException;Lcom/alibaba/sdk/android/oss/ServiceException;)V
    ...
    .line 1
    iget-object p1, p0, Ly/JL$startUpload$ossAsyncTask$1;->$zipFile:Ljava/io/File;
    ...
    .line 2
    iget-object p1, p0, Ly/JL$startUpload$ossAsyncTask$1;->$localMedia:Lcom/luck/picture/lib/entity/LocalMedia;
    ...
    .line 4
    :cond_0
    iget-object p1, p0, Ly/JL$startUpload$ossAsyncTask$1;->this$0:Ly/JL;
    ...
    :cond_1
    iget-object p1, p1, Ltop/fudh/tdj/xfzoct/databinding/FragmentComPostDetailBinding;->o:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    :cond_2
    new-instance p3, Ly/JL$startUpload$ossAsyncTask$1$onFailure$1;

    iget-object v0, p0, Ly/JL$startUpload$ossAsyncTask$1;->this$0:Ly/JL;

    invoke-direct {p3, v0, p2}, Ly/JL$startUpload$ossAsyncTask$1$onFailure$1;-><init>(Ly/JL;Lcom/alibaba/sdk/android/oss/ClientException;)V
...
.method public progress(Ljava/lang/Object;JJ)V
    ...
    .line 2
    iget p2, p0, Ly/JL$startUpload$ossAsyncTask$1;->progress:I
    ...
    .line 4
    :cond_0
    iput p1, p0, Ly/JL$startUpload$ossAsyncTask$1;->progress:I
...
.method public success(Lcom/alibaba/sdk/android/oss/model/PutObjectRequest;Lcom/alibaba/sdk/android/oss/model/PutObjectResult;)V
    ...
    invoke-static {p1}, Ly/JL;->access$getUploadNum$p(Ly/JL;)I
    ...
    invoke-static {p1, p2}, Ly/JL;->access$setUploadNum$p(Ly/JL;I)V
    ...
    iget-object p2, p0, Ly/JL$startUpload$ossAsyncTask$1;->this$0:Ly/JL;

    invoke-static {p2}, Ly/JL;->access$getUploadNum$p(Ly/JL;)I
    ...
    invoke-static {p2}, Ly/JL;->access$getMLocalMedia$p(Ly/JL;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, p2}, Ly/f;-><init>(Ly/JL;)V
