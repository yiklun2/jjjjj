.class public final Lz/JS$startUpload$ossAsyncTask$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lz/JS;->startUpload(Lcom/luck/picture/lib/entity/LocalMedia;Ljava/io/File;)V
.end annotation
...
# direct methods
.method public constructor <init>(Lz/JS;Ljava/io/File;Lcom/luck/picture/lib/entity/LocalMedia;)V
    .locals 0

    iput-object p1, p0, Lz/JS$startUpload$ossAsyncTask$1;->this$0:Lz/JS;

    iput-object p2, p0, Lz/JS$startUpload$ossAsyncTask$1;->$zipFile:Ljava/io/File;

    iput-object p3, p0, Lz/JS$startUpload$ossAsyncTask$1;->$localMedia:Lcom/luck/picture/lib/entity/LocalMedia;
...
.method public static synthetic a(Lz/JS;)V
    .locals 0

    invoke-static {p0}, Lz/JS$startUpload$ossAsyncTask$1;->success$lambda-0(Lz/JS;)V

    return-void
.end method

.method private static final success$lambda-0(Lz/JS;)V
    .locals 2
    ...
    .line 2
    invoke-static {p0}, Lz/JS;->access$getMUploadInfoBean$p(Lz/JS;)Ltop/wjtinf/nggka/iapkg/bean/release/UploadInfoBean;
    ...
    .line 5
    invoke-static {p0}, Lz/JS;->access$getFileNames$p(Lz/JS;)Ljava/util/ArrayList;
...
.method public final getProgress()I
    ...
    .line 1
    iget v0, p0, Lz/JS$startUpload$ossAsyncTask$1;->progress:I
...
.method public onFailure(Lcom/alibaba/sdk/android/oss/model/PutObjectRequest;Lcom/alibaba/sdk/android/oss/ClientException;Lcom/alibaba/sdk/android/oss/ServiceException;)V
    ...
    .line 1
    iget-object p1, p0, Lz/JS$startUpload$ossAsyncTask$1;->$zipFile:Ljava/io/File;
    ...
    .line 2
    iget-object p1, p0, Lz/JS$startUpload$ossAsyncTask$1;->$localMedia:Lcom/luck/picture/lib/entity/LocalMedia;
    ...
    .line 4
    :cond_0
    iget-object p1, p0, Lz/JS$startUpload$ossAsyncTask$1;->this$0:Lz/JS;
    ...
    :cond_1
    iget-object p1, p1, Ltop/fudh/tdj/xfzoct/databinding/FragmentSendMsgBinding;->m:Landroid/widget/TextView;
    ...
    :cond_2
    new-instance p3, Lz/JS$startUpload$ossAsyncTask$1$onFailure$1;

    iget-object v0, p0, Lz/JS$startUpload$ossAsyncTask$1;->this$0:Lz/JS;

    invoke-direct {p3, v0, p2}, Lz/JS$startUpload$ossAsyncTask$1$onFailure$1;-><init>(Lz/JS;Lcom/alibaba/sdk/android/oss/ClientException;)V
...
.method public progress(Ljava/lang/Object;JJ)V
    ...
    .line 2
    iget p2, p0, Lz/JS$startUpload$ossAsyncTask$1;->progress:I
    ...
    .line 4
    :cond_0
    iput p1, p0, Lz/JS$startUpload$ossAsyncTask$1;->progress:I
...
.method public success(Lcom/alibaba/sdk/android/oss/model/PutObjectRequest;Lcom/alibaba/sdk/android/oss/model/PutObjectResult;)V
    ...
    invoke-static {p1}, Lz/JS;->access$getUploadNum$p(Lz/JS;)I
    ...
    invoke-static {p1, p2}, Lz/JS;->access$setUploadNum$p(Lz/JS;I)V
    ...
    iget-object p2, p0, Lz/JS$startUpload$ossAsyncTask$1;->this$0:Lz/JS;

    invoke-static {p2}, Lz/JS;->access$getUploadNum$p(Lz/JS;)I
    ...
    invoke-static {p2}, Lz/JS;->access$getMLocalMedias$p(Lz/JS;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, p2}, Lrc/h;-><init>(Lz/JS;)V
