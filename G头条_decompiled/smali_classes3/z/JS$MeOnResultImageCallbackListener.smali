.class public final Lz/JS$MeOnResultImageCallbackListener;
...
.method public constructor <init>(Lz/JS;)V
    ...
    .line 1
    iput-object p1, p0, Lz/JS$MeOnResultImageCallbackListener;->this$0:Lz/JS;
...
.method public static synthetic a(Ljava/util/ArrayList;Lz/JS;)V
    .locals 0

    invoke-static {p0, p1}, Lz/JS$MeOnResultImageCallbackListener;->onResult$lambda-1$lambda-0(Ljava/util/ArrayList;Lz/JS;)V

    return-void
.end method

.method private static final onResult$lambda-1$lambda-0(Ljava/util/ArrayList;Lz/JS;)V
    .locals 1
    ...
    invoke-static {p1, p0}, Lz/JS;->access$setMLocalMedia$p(Lz/JS;Lcom/luck/picture/lib/entity/LocalMedia;)V
...
.method public onResult(Ljava/util/ArrayList;)V
    ...
    .line 1
    :cond_0
    iget-object v0, p0, Lz/JS$MeOnResultImageCallbackListener;->this$0:Lz/JS;

    .line 2
    new-instance v1, Lrc/g;

    invoke-direct {v1, p1, v0}, Lrc/g;-><init>(Ljava/util/ArrayList;Lz/JS;)V
