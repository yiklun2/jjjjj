...
.method public static c(Lcom/google/android/exoplayer2/upstream/HttpDataSource$b;Ljava/lang/String;[BLjava/util/Map;)[B
    ...
    invoke-direct {v0, p0}, Lg6/w;-><init>(Lcom/google/android/exoplayer2/upstream/b;)V

    .line 2
    new-instance p0, Lcom/google/android/exoplayer2/upstream/c$b;

    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/c$b;-><init>()V

    .line 3
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c$b;->j(Ljava/lang/String;)Lcom/google/android/exoplayer2/upstream/c$b;

    move-result-object p0

    .line 4
    invoke-virtual {p0, p3}, Lcom/google/android/exoplayer2/upstream/c$b;->e(Ljava/util/Map;)Lcom/google/android/exoplayer2/upstream/c$b;
    ...
    .line 5
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c$b;->d(I)Lcom/google/android/exoplayer2/upstream/c$b;

    move-result-object p0

    .line 6
    invoke-virtual {p0, p2}, Lcom/google/android/exoplayer2/upstream/c$b;->c([B)Lcom/google/android/exoplayer2/upstream/c$b;
    ...
    .line 7
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/c$b;->b(I)Lcom/google/android/exoplayer2/upstream/c$b;
    ...
    invoke-direct {p2, v0, p1}, Lg6/j;-><init>(Lcom/google/android/exoplayer2/upstream/b;Lcom/google/android/exoplayer2/upstream/c;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1

    .line 10
    :try_start_1
    invoke-static {p2}, Lcom/google/android/exoplayer2/util/c;->Z0(Ljava/io/InputStream;)[B
    ...
    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/upstream/c$b;->j(Ljava/lang/String;)Lcom/google/android/exoplayer2/upstream/c$b;
    ...
    .line 20
    invoke-virtual {v0}, Lg6/w;->l()Ljava/util/Map;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;-><init>(Lcom/google/android/exoplayer2/upstream/c;Landroid/net/Uri;Ljava/util/Map;JLjava/lang/Throwable;)V
...
.method public a(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/g$a;)[B
    ...
    .line 14
    iget-object p1, p0, Lcom/google/android/exoplayer2/drm/i;->a:Lcom/google/android/exoplayer2/upstream/HttpDataSource$b;

    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/g$a;->a()[B

    move-result-object p2

    invoke-static {p1, v0, p2, v1}, Lcom/google/android/exoplayer2/drm/i;->c(Lcom/google/android/exoplayer2/upstream/HttpDataSource$b;Ljava/lang/String;[BLjava/util/Map;)[B
    ...
    new-instance p2, Lcom/google/android/exoplayer2/upstream/c$b;

    invoke-direct {p2}, Lcom/google/android/exoplayer2/upstream/c$b;-><init>()V

    sget-object v0, Landroid/net/Uri;->EMPTY:Landroid/net/Uri;

    .line 17
    invoke-virtual {p2, v0}, Lcom/google/android/exoplayer2/upstream/c$b;->i(Landroid/net/Uri;)Lcom/google/android/exoplayer2/upstream/c$b;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;-><init>(Lcom/google/android/exoplayer2/upstream/c;Landroid/net/Uri;Ljava/util/Map;JLjava/lang/Throwable;)V

    throw p1
.end method

.method public b(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/g$g;)[B
    .locals 2

    .line 1
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/g$g;->b()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/g$g;->a()[B
    ...
    .line 2
    iget-object p2, p0, Lcom/google/android/exoplayer2/drm/i;->a:Lcom/google/android/exoplayer2/upstream/HttpDataSource$b;
    ...
    .line 4
    invoke-static {p2, p1, v1, v0}, Lcom/google/android/exoplayer2/drm/i;->c(Lcom/google/android/exoplayer2/upstream/HttpDataSource$b;Ljava/lang/String;[BLjava/util/Map;)[B
