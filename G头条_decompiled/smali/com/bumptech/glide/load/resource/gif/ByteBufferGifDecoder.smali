...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2}, Lcom/bumptech/glide/c;->e()Lc3/b;

    move-result-object v2

    .line 4
    invoke-direct {p0, p1, v0, v1, v2}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;-><init>(Landroid/content/Context;Ljava/util/List;Lc3/e;Lc3/b;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lc3/e;Lc3/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v6}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;-><init>(Landroid/content/Context;Ljava/util/List;Lc3/e;Lc3/b;Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$b;Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$a;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lc3/e;Lc3/b;Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$b;Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$a;)V
    .locals 0
    ...
    invoke-direct {p1, p3, p4}, Lm3/a;-><init>(Lc3/e;Lc3/b;)V

    iput-object p1, p0, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->e:Lm3/a;
...
.method public static e(Ly2/c;II)I
    .locals 4
...
.method public bridge synthetic a(Ljava/lang/Object;Lz2/e;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->f(Ljava/nio/ByteBuffer;Lz2/e;)Z
...
.method public bridge synthetic b(Ljava/lang/Object;IILz2/e;)Lb3/j;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->d(Ljava/nio/ByteBuffer;IILz2/e;)Lm3/c;
...
.method public final c(Ljava/nio/ByteBuffer;IILy2/d;Lz2/e;)Lm3/c;
    .locals 16
    ...
    .line 2
    :try_start_0
    invoke-virtual/range {p4 .. p4}, Ly2/d;->c()Ly2/c;
    ...
    .line 4
    :cond_0
    sget-object v7, Lm3/f;->a:Lz2/d;

    move-object/from16 v9, p5

    invoke-virtual {v9, v7}, Lz2/e;->c(Lz2/d;)Ljava/lang/Object;
    ...
    .line 7
    invoke-static {v0, v13, v14}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->e(Ly2/c;II)I

    move-result v9

    .line 8
    iget-object v10, v1, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->d:Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$a;

    iget-object v11, v1, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->e:Lm3/a;

    move-object/from16 v12, p1

    invoke-virtual {v10, v11, v0, v12, v9}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$a;->a(Ly2/a$a;Ly2/c;Ljava/nio/ByteBuffer;I)Ly2/a;

    move-result-object v11

    .line 9
    invoke-interface {v11, v7}, Ly2/a;->e(Landroid/graphics/Bitmap$Config;)V

    .line 10
    invoke-interface {v11}, Ly2/a;->b()V

    .line 11
    invoke-interface {v11}, Ly2/a;->a()Landroid/graphics/Bitmap;
    ...
    invoke-static {v4, v5}, Lv3/e;->a(J)D
    ...
    invoke-direct/range {v9 .. v15}, Lcom/bumptech/glide/load/resource/gif/GifDrawable;-><init>(Landroid/content/Context;Ly2/a;Lz2/h;IILandroid/graphics/Bitmap;)V

    .line 16
    new-instance v7, Lm3/c;

    invoke-direct {v7, v0}, Lm3/c;-><init>(Lcom/bumptech/glide/load/resource/gif/GifDrawable;)V
    :try_end_1
...
.method public d(Ljava/nio/ByteBuffer;IILz2/e;)Lm3/c;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$b;->a(Ljava/nio/ByteBuffer;)Ly2/d;
    ...
    .line 2
    :try_start_0
    invoke-virtual/range {v1 .. v6}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder;->c(Ljava/nio/ByteBuffer;IILy2/d;Lz2/e;)Lm3/c;
    ...
    invoke-virtual {p2, v0}, Lcom/bumptech/glide/load/resource/gif/ByteBufferGifDecoder$b;->b(Ly2/d;)V
...
.method public f(Ljava/nio/ByteBuffer;Lz2/e;)Z
    .locals 1
    .param p1    # Ljava/nio/ByteBuffer;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
