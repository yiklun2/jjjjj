...
.method public constructor <init>(Landroidx/core/animation/AnimationHandler$AnimationFrameCallbackProvider;)V
    ...
    .line 4
    :cond_0
    new-instance p1, Landroidx/core/animation/AnimationHandler$FrameCallbackProvider14;

    invoke-direct {p1, p0}, Landroidx/core/animation/AnimationHandler$FrameCallbackProvider14;-><init>(Landroidx/core/animation/AnimationHandler;)V
...
.method private getAnimationCallbacks()Ljava/util/ArrayList;
    ...
    .line 1
    sget-object v0, Landroidx/core/animation/AnimationHandler;->sAnimationCallbackData:Ljava/lang/ThreadLocal;

    invoke-virtual {v0}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;

    if-nez v1, :cond_0

    .line 2
    new-instance v1, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;

    invoke-direct {v1}, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;-><init>()V
    ...
    .line 4
    :cond_0
    iget-object v0, v1, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;->mAnimationCallbacks:Ljava/util/ArrayList;
...
.method private getDelayedCallbackStartTime()Landroidx/collection/SimpleArrayMap;
    ...
    .line 4
    :cond_0
    iget-object v0, v1, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;->mDelayedCallbackStartTime:Landroidx/collection/SimpleArrayMap;
...
.method private isListDirty()Z
    ...
    .line 4
    :cond_0
    iget-boolean v0, v1, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;->mListDirty:Z
...
.method private setListDirty(Z)V
    ...
    .line 4
    :cond_0
    iput-boolean p1, v1, Landroidx/core/animation/AnimationHandler$AnimationCallbackData;->mListDirty:Z
...
.method public onAnimationFrame(J)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/core/animation/AnimationHandler;->mProvider:Landroidx/core/animation/AnimationHandler$AnimationFrameCallbackProvider;

    invoke-interface {p1}, Landroidx/core/animation/AnimationHandler$AnimationFrameCallbackProvider;->postFrameCallback()V
