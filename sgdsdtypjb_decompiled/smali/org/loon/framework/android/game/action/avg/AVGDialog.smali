.class public final Lorg/loon/framework/android/game/action/avg/AVGDialog;
.super Ljava/lang/Object;
.source "AVGDialog.java"
...
.method public static clear()V
    ...
    sget-object v0, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
...
.method public static final getRMXPDialog(Ljava/lang/String;II)Lorg/loon/framework/android/game/core/graphics/LImage;
    ...
    sput-object v0, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
    ...
    invoke-static {p0, p1, p2, v0, v6}, Lorg/loon/framework/android/game/action/avg/AVGDialog;->getRMXPDialog(Lorg/loon/framework/android/game/core/graphics/LImage;IIII)Lorg/loon/framework/android/game/core/graphics/LImage;
...
.method private static final getRMXPDialog(Lorg/loon/framework/android/game/core/graphics/LImage;IIII)Lorg/loon/framework/android/game/core/graphics/LImage;
    ...
    sget-object v3, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
    ...
    sput-object v3, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
    ...
    sget-object v4, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
...
.method public static final getRMXPloadBuoyage(Ljava/lang/String;II)Lorg/loon/framework/android/game/core/graphics/LImage;
    ...
    invoke-static {p0, p1, p2}, Lorg/loon/framework/android/game/action/avg/AVGDialog;->getRMXPloadBuoyage(Lorg/loon/framework/android/game/core/graphics/LImage;II)Lorg/loon/framework/android/game/core/graphics/LImage;
...
.method public static final getRMXPloadBuoyage(Lorg/loon/framework/android/game/core/graphics/LImage;II)Lorg/loon/framework/android/game/core/graphics/LImage;
    ...
    sget-object v1, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
    ...
    sput-object v1, Lorg/loon/framework/android/game/action/avg/AVGDialog;->lazyImages:Ljava/util/Map;
    ...
    :try_start_0
    invoke-static/range {v10 .. v16}, Lorg/loon/framework/android/game/utils/GraphicsUtils;->drawClipImage(Lorg/loon/framework/android/game/core/graphics/LImage;IIIIII)Lorg/loon/framework/android/game/core/graphics/LImage;

    move-result-object v10

    const/4 v11, 0x0

    invoke-static {v0, v8, v11}, Lorg/loon/framework/android/game/core/graphics/LImage;->createImage(IIZ)Lorg/loon/framework/android/game/core/graphics/LImage;

    move-result-object v12

    invoke-virtual {v12}, Lorg/loon/framework/android/game/core/graphics/LImage;->getLGraphics()Lorg/loon/framework/android/game/core/graphics/device/LGraphics;
    ...
    invoke-virtual {v13, v11, v2, v2}, Lorg/loon/framework/android/game/core/graphics/device/LGraphics;->drawImage(Lorg/loon/framework/android/game/core/graphics/LImage;II)V

    invoke-virtual {v13, v14, v2, v2}, Lorg/loon/framework/android/game/core/graphics/device/LGraphics;->drawImage(Lorg/loon/framework/android/game/core/graphics/LImage;II)V

    add-int/lit8 v0, v0, -0x1

    invoke-virtual {v13, v15, v0, v2}, Lorg/loon/framework/android/game/core/graphics/device/LGraphics;->drawImage(Lorg/loon/framework/android/game/core/graphics/LImage;II)V

    invoke-virtual {v13, v10, v2, v2}, Lorg/loon/framework/android/game/core/graphics/device/LGraphics;->drawImage(Lorg/loon/framework/android/game/core/graphics/LImage;II)V

    add-int/lit8 v0, v8, -0x1

    invoke-virtual {v13, v1, v2, v0}, Lorg/loon/framework/android/game/core/graphics/device/LGraphics;->drawImage(Lorg/loon/framework/android/game/core/graphics/LImage;II)V

    invoke-virtual {v13}, Lorg/loon/framework/android/game/core/graphics/device/LGraphics;->dispose()V
